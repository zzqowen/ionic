  ...
  function ionGallery($ionicPlatform, ionGalleryHelper, ionGalleryConfig) {
    ...
    function controller($scope) {
      ...
      var _drawGallery = function () {
        $scope.ionGalleryRowSize = ionGalleryHelper.getRowSize(_rowSize || ionGalleryConfig.row_size, $scope.ionGalleryItems ? $scope.ionGalleryItems.length : 0);
      ...
      (function () {
        $scope.$watch(function () {
          if (!$scope.ionGalleryItems) return 0;
...
(function(){
  ...
  function ionSlider($ionicModal,ionGalleryHelper,$ionicPlatform,$timeout,$ionicScrollDelegate){
    ...
    function controller($scope){
      ...
      var serviceMode = (typeof $scope.selected !== 'undefined');

      if (serviceMode) {
        lastSlideIndex = $scope.selected;
